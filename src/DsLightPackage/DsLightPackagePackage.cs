...
namespace deceed.DsLightPackage
{
    ...
    [ProvideEditorExtension(typeof(EditorFactory), ".dslt", 50, 
              ProjectGuid = "{A2FE74E1-B743-11d0-AE1A-00A0C90FFFC3}", 
              TemplateDir = "Templates", 
              NameResourceID = 105,
              DefaultName = "DsLight")]
    [ProvideKeyBindingTable(GuidList.guidDsLightPackageEditorFactoryString, 102)]
    ...
    public sealed class DsLightPackagePackage : Package
    {
        /// <summary>
